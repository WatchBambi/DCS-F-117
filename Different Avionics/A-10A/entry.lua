...
version		 = "2.7 Build",
state		 = "installed",
info		 = _("F-117, also called Nighthawk, single-seat, twin-engine jet fighter-bomber built by the Lockheed Corporation (now part of the Lockheed Martin Corporation) for the U.S. Air Force. It was the first stealth aircraft—i.e., an aircraft designed entirely around the concept of evading detection by radar and other sensors."),
binaries	 = { 'CustomFM', },
...
FM.old 		= 17
-------------------------------------------------------------------------------
make_flyable('F-117',current_mod_path..'/Cockpit/KneeboardRight/', FM, current_mod_path..'/comm.lua')--EFM FC3
-------------------------------------------------------------------------------------
